...
public class Utils {
    ...
    public static String makeCanonicalString(String method, String bucket, String key, Map pathArgs, Map headers) {
     ...
     */
    public static String makeCanonicalString(String method, String bucketName, String key, Map pathArgs, 
